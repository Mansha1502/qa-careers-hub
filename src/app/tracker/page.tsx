  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      ...
      {entries.length === 0 ? (
        <Link
          href="/#jobs"
          className="mt-6 inline-flex items-center gap-2 rounded-lg bg-[var(--accent)] px-4 py-2.5 text-sm font-semibold text-[var(--accent-foreground)] transition-colors hover:bg-[var(--accent-hover)]"
        >
          Browse open roles
        </Link>
      ) : (
                  ...
                  {items.map(({ entry, job }) => (
                    ...
                    >
                      <Link href={`/jobs/${job.id}`} className="flex min-w-0 items-center gap-3">
                        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[var(--accent-soft)] text-xs font-semibold text-[var(--accent)]">
                      ...
                      <div className="flex shrink-0 items-center gap-2 sm:pl-4">
                        ...
                        <button
                          ...
                          className="rounded-lg p-1.5 text-[var(--muted)] transition-colors hover:bg-[var(--surface-hover)] hover:text-red-600 dark:hover:text-red-400"
                        >
